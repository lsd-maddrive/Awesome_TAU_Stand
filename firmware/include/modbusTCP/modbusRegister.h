...
//analog_reg
#define STATUS_MOTOR                                        0

#define DATA_CURRENT_SENSOR_CURRENT                         1
#define STATUS_CURRENT                                      2

#define DATA_INC_ENCODER_ROTATIONAL_SPEED                   3
#define STATUS_INC_ENCODER                                  5

#define DATA_ABS_ENCODER_ANGLE_OF_ROTATION                  6
#define DATA_ABS_ENCODER_MULTI_TURN_ANGLE_OF_ROTATION       8
#define DATA_ABS_ENCODER_ROTATIONAL_SPEED                   10
#define DATA_ABS_ENCODER_NUMBER_OF_TURNS                    12

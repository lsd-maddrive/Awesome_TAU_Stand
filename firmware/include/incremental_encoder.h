...
/*
 * @brief   This coefficient must be multiplied by the number of interrupts to get the rotation speed.
 *
 * @note    60/(period of incremental_encoder * maximum number of points in the encoder)
 *
 *          60 - converts to minutes.
 *          period of incremental_encoder - Set below in the variable "TIMER_PERIOD_OF_INCREMENTAL_ENCODER".
 *          maximum number of points in the encoder - 500.
 *
 */
#define COEF_INCREMENTAL_ENCODER_VELOCITY 60/(TIMER_PERIOD_OF_INCREMENTAL_ENCODER * 500)
...
#define INCREMENTAL_ENCODER_PAD_A PAL_LINE(INCREMENTAL_ENCODER_PORT_A, 0) // One leg of the controller that will be used for interrupts.
...
#define INCREMENTAL_ENCODER_PORT_B GPIOA // All legs of the same port that will be used for determining the direction of speed.
#define INCREMENTAL_ENCODER_PAD_B PAL_LINE(INCREMENTAL_ENCODER_PORT_B, 1) // One leg of the controller that will be used for determining the direction of speed.

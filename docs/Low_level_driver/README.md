...
<p align="center">
<img src="picture/Low_Level_Driver.png" width=400/>
</p>

Система может находиться в одном из трёх состояний:

В состоянии LLD_UNINIT заполняется структура, в которой определяется первоначально подключенная нагрузка, а также желаемый регулятор.
